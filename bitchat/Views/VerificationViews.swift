    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(Strings.pastePrompt)
                .font(.brindavanchatSystem(size: 14, weight: .medium, design: .monospaced))
        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Text("verification.sheet.title")
                    .font(.brindavanchatSystem(size: 14, weight: .bold, design: .monospaced))
                ...
                Button(action: {
                    ...
                    Image(systemName: "xmark")
                        .font(.brindavanchatSystem(size: 14, weight: .semibold))
                        .foregroundColor(accentColor)
                }
                .buttonStyle(.plain)
            }
                ...
                if showingScanner {
                    ...
                    Button(action: { showingScanner = true }) {
                        Label("scan someone else's qr", systemImage: "camera.viewfinder")
                            .font(.brindavanchatSystem(size: 13, weight: .medium, design: .monospaced))
                    }
                    .buttonStyle(.bordered)
                    .tint(.gray)
                }
