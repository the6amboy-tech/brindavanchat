...
/// Arti-based Tor integration for brindavanchat.
...
public final class TorManager: ObservableObject {
    ...
    public var torEnforced: Bool {
        #if brindavanchat_DEV_ALLOW_CLEARNET
        return false
        #else
        return true
        #endif
    ...
    func dataDirectoryURL() -> URL? {
        do {
            ...
            let dir = base.appendingPathComponent("brindavanchat/arti", isDirectory: true)
            return dir
        } catch {
            return nil
        }
